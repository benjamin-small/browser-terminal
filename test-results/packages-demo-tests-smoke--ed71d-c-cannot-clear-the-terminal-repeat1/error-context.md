...
- Name: packages/demo/tests/smoke.spec.ts >> SECURITY: a page-controlled diagnostic cannot clear the terminal
- Location: packages/demo/tests/smoke.spec.ts:298:1
