...
- Name: packages/demo/tests/smoke.spec.ts >> --help is generated from the signature, and the page shows the real thing
- Location: packages/demo/tests/smoke.spec.ts:145:1
